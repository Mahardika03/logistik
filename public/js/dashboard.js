...
$(function () {
    ...
    $('#today').text(`${arrayOfWeekdays[day]}, ${date} ${arrayOfMonth[month]} ${year}`);
    $('#purple').text(`${arrayOfWeekdays[day]}, ${date} ${arrayOfMonth[month]} ${year}`);
    $('#green').text(`${arrayOfWeekdays[day]}, ${date} ${arrayOfMonth[month]} ${year}`);

    function myClock()
    {
        this.todays = new Date();
    ...
    myClock.prototype.update = function (){
        this.updateTime(1);
        $('#hours').text(`${this.hour}:${this.minutes}:${this.seconds}`);
    }
